...
public class Part2Test extends TestBase {
  ...
  public void testAddToPlaylist() {
    ...
    assertThat(outputStream.toString(),
        containsString("createPlaylist needs implementation\n" +
  ...
  public void testAddVideoToPlaylistNonExistentVideo() {
    ...
    assertThat(lines[0],
        containsString("createPlaylist needs implementation"));
    assertThat(lines[2],
        containsString("addVideoToPlaylist needs implementation"));
  }
  ...
  public void testShowAllPlaylistsNoPlaylistsExist() {
    ...
    assertEquals(1, getOutputLines().length);
    assertThat(outputStream.toString(), containsString("showAllPlaylists needs implementation"));
  }
  ...
  public void showPlaylistAfterRemoveAVideoFromPlaylistThenReAdd() {
    ...
    assertThat(lines[5], containsString("showPlaylist needs implementation"));
    assertThat(lines[6],
        containsString("showPlaying needs implementation"));
    assertThat(lines[7],
        containsString("showAllPlaylists needs implementation"));
  }
  ...
  public void testRemoveFromPlaylistNonexistentVideo() {
    ...
    assertThat(lines[0],
        containsString("createPlaylist needs implementation"));
    assertThat(lines[1], containsString("addVideoToPlaylist needs implementation"));
    assertThat(lines[2],
        containsString("removeFromPlaylist needs implementation"));
  }
  ...
  public void testClearPlaylistNonexistent() {
    ...
    assertEquals(1, getOutputLines().length);
    assertThat(outputStream.toString(),
        containsString("clearPlaylist needs implementation"));
  }
  ...
  public void testDeletePlaylist() {
    ...
    assertThat(lines[0],
        containsString("createPlaylist needs implementation"));
    assertThat(lines[1], containsString("deletePlaylist needs implementation"));
  }
